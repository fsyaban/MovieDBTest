...
class YouTubePlayerSupportFragmentX : Fragment(),
    ...
    private val a: Initializer = Initializer()
    ...
    override fun initialize(
        var1: String,
        var2: YouTubePlayer.OnInitializedListener
    ) {
    ...
    override fun onDestroyView() {
        c?.c(requireActivity().isFinishing)
        c = null
        super.onDestroyView()
    }
    ...
    private inner class Initializer : com.google.android.youtube.player.YouTubePlayerView.b {
    ...
    abstract class OnInitializedListener:YouTubePlayer.OnInitializedListener
}